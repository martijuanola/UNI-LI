...
path( NumCitiesRemainingToBeVisited, RemainingKm, CurrentCity, CitiesAlreadyVisited, [CurrentCity1|Path] ):-
    ...
    \+member(CurrentCity,CitiesAlreadyVisited),
    NumCitiesRemainingToBeVisited2 is NumCitiesRemainingToBeVisited-1,
    RemainingKm2 is RemainingKm-K,
    append(CitiesAlreadyVisited,[CurrentCity],CitiesAlreadyVisited2),
    path(NumCitiesRemainingToBeVisited2, RemainingKm2, CurrentCity1, CitiesAlreadyVisited2, Path).
